...
Ts = np.array([0.])
Us = np.array([-2.0])
Vs = np.array(["0.25", "0.20", "0.1", "0.05", "0.01", "0.005", "0.001", "0.0005", "0.0001", "0.00005", "0.0"])
...
for T, U, V in iterate_containers(Ts, Us, Vs):
    ...
    ax.plot(w_lin, data, linewidth=(plt.rcParams["lines.linewidth"]), linestyle="--", label=f"$V={V}$")
