...
for i, tau in enumerate([10, 50, 100, 500, 1000, -1]):
    #main_df = data_loader.load_panda("HHG", "cl1_8_cycle/cosine_laser/PiFlux", "current_density.json.gz", 
    #                 **hhg_params(T=300, E_F=118, v_F=1.5e5, band_width=400, field_amplitude=1.6, photon_energy=5.25, decay_time=tau))
    main_df = data_loader.load_panda("HHG", "8_cycle_asym/cosine_laser/Honeycomb", "current_density.json.gz", 
