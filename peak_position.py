...
Ts = np.array([0.])
Us = np.array([-2.0])
Vs = np.array(["4.0", "3.5", "3.0", "2.5", "2.0", "1.5", "1.4", "1.3", "1.2", "1.1",
               "1.0", "0.9", "0.8", "0.7", "0.6", "0.5", 
               "0.45", "0.4", "0.35", "0.3", "0.25", "0.2", "0.15",
               "0.1", "0.07", "0.05", "0.04", "0.03", "0.02", "0.01", 
               "0.007", "0.005", "0.004", "0.002", "0.001", "0.0005", "0.0001", "0.00005"])
...
for T, U, V in iterate_containers(Ts, Us, Vs):
    name = f"T={T}/U={U}_V={V}"
    data, data_real, w_lin, res = cf.resolvent_data(f"{folder}{name}", name_suffix, 1e-4, plot_upper_lim, number_of_values=30000, imaginary_offset=1e-6, xp_basis=True)
