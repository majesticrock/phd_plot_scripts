...
Ts = np.array([0.])
Us = np.array([3.7, 3.725, 3.75, 3.775, 3.8, 3.825, 3.85, 3.875, 3.9,  # 9
               3.925, 3.94, 3.95, 3.97, 3.975, 3.985, 3.99, 3.995, # 8
               3.997, 3.9985, 3.999, 3.9995, # 4
               4.0, # 1
               4.0005, 4.001, 4.0015, 4.003, # 4
               4.005, 4.01, 4.015, 4.025, 4.03, 4.05, 4.06, 4.075, # 8
               4.1, 4.125, 4.15, 4.175, 4.2, 4.225, 4.25, 4.275, 4.3 # 9
               ])
Vs = np.array([1.])
