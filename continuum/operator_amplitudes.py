...
params = continuum_params(N_k=N, 
                          ...
                          g=2.5, 
                          omega_D=10)
main_df = data_loader.load_panda("continuum", DIR, "full_diagonalization.json.gz", print_date=False, **params)
gap_df = data_loader.load_panda("continuum", DIR, "gap.json.gz", print_date=False, **params)
