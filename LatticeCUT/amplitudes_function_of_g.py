...
epsilon = np.linspace(-1, 1, N) - E_F
Gs = [2.35, 2.4, 2.45, 2.5, 2.55, 2.6, 2.7, 2.65, 2.8, 2.9, 3.0]
...
for i, g in enumerate(Gs):
    params = lattice_cut_params(N=N, 
                                ...
                                E_F=E_F,
                                omega_D=0.02)
    main_df = data_loader.load_panda("lattice_cut", f"./{SYSTEM}", "full_diagonalization.json.gz", **params)
...
axes_wv[0].legend(loc="upper left", ncols=2)
